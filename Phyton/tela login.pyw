...
class Principal: #cria a classe principal 
    def __init__(self, master=None):  #cria o método inicial e que será filho da classe Principal
        ...
        self.Container1["bg"] = "light blue" # define uma cor de fundo
...
#Método para verificar senha
    def verificaSenha(self):
        ...
        if usuario == "Antonio" and senha == "xxx":
            self.mensagem["text"] = "Usuário Correto!"
            self.nome["fg"] = "light green"
            self.senha["fg"] = "light green"
